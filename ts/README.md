...
The TypeScript SDK for the FreeDictionaryApi2 API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new FreeDictionaryApi2SDK({ apikey: '...' })
