...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FREEDICTIONARYAPI2_TEST_LIVE ||
    'TRUE' === process.env.FREEDICTIONARYAPI2_TEST_OVERRIDE
  ) {
  ...
  m.FREEDICTIONARYAPI2_TEST_EXPLAIN = process.env.FREEDICTIONARYAPI2_TEST_EXPLAIN || m.FREEDICTIONARYAPI2_TEST_EXPLAIN
