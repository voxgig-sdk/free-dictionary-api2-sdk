...
(0, node_test_1.describe)('EntryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreeDictionaryApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-entry', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["language01", "word01"]))
            return;
...
function liveScenariosActive() { return false && process.env.FREE_DICTIONARY_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeDictionaryApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_DICTIONARY_API2_TEST_ENTRY_ENTID'];
    ...
    const client = new __1.FreeDictionaryApi2SDK({
        base: 'http://localhost:8080',
