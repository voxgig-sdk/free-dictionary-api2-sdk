...
func registerSDKWords(r *eng.Registry, client *sdk.FreeDictionaryApi2SDK) {
...
func runOp(client *sdk.FreeDictionaryApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
