// Command FreeDictionaryApi2-cli is a CLI + REPL for the FreeDictionaryApi2 SDK,
...
const prompt = "free-dictionary-api2"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "entry language"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FREE_DICTIONARY_API2_APIKEY (api key), FREE_DICTIONARY_API2_BASE (base url override)")
