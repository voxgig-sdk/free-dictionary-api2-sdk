...
AQL-driven CLI and REPL for the FreeDictionaryApi2 SDK. Positional arguments are
...
```sh
go build -o free-dictionary-api2-cli ./...
```
...
./free-dictionary-api2-cli list entry
./free-dictionary-api2-cli load 1 entry
./free-dictionary-api2-cli load '{id:1}' entry
