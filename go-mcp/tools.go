...
type Args struct {
	Entity string         `json:"entity" jsonschema:"entry | language"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeDictionaryApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-dictionary-api2_list",
		Description: "List records from FreeDictionaryApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-dictionary-api2_load",
		Description: "Load a single record from FreeDictionaryApi2. " +
...
func runOp(client *sdk.FreeDictionaryApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeDictionaryApi2SDK, name string) (sdk.FreeDictionaryApi2Entity, error) {
