// Command FreeDictionaryApi2-mcp is an MCP server exposing the FreeDictionaryApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FreeDictionaryApi2_list  — list records of an entity
//	FreeDictionaryApi2_load  — load a single record of an entity
//
...
func main() {
	...
	client := sdk.NewFreeDictionaryApi2SDK(nil)
