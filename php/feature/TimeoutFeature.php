...
// FreeDictionaryApi2 SDK timeout feature
...
class FreeDictionaryApi2TimeoutFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _with_timeout(FreeDictionaryApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeDictionaryApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
