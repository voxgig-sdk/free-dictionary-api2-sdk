...
// FreeDictionaryApi2 SDK proxy feature
...
class FreeDictionaryApi2ProxyFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    public function init(FreeDictionaryApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeDictionaryApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
