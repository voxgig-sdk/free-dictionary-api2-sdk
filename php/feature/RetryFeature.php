...
// FreeDictionaryApi2 SDK retry feature
...
class FreeDictionaryApi2RetryFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    public function init(FreeDictionaryApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeDictionaryApi2Context $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(FreeDictionaryApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(FreeDictionaryApi2Context $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
