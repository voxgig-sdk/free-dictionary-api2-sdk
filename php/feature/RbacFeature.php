...
// FreeDictionaryApi2 SDK rbac feature
...
class FreeDictionaryApi2RbacFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _required(FreeDictionaryApi2Context $ctx): ?string
    {
    ...
    private function _reject(FreeDictionaryApi2Context $ctx, string $required): void
    {
    ...
    private function _track(FreeDictionaryApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
