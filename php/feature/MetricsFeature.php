...
// FreeDictionaryApi2 SDK metrics feature
...
class FreeDictionaryApi2MetricsFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _record(FreeDictionaryApi2Context $ctx, bool $ok): void
    {
