...
// FreeDictionaryApi2 SDK cache feature
...
class FreeDictionaryApi2CacheFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _through(FreeDictionaryApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
