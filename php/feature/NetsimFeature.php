...
// FreeDictionaryApi2 SDK netsim feature
...
class FreeDictionaryApi2NetsimFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _simulate(FreeDictionaryApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeDictionaryApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
