...
// FreeDictionaryApi2 SDK streaming feature
...
class FreeDictionaryApi2StreamingFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _iterate(FreeDictionaryApi2Result $result): \Generator
    {
    ...
    private function _streamable(FreeDictionaryApi2Context $ctx): bool
    {
