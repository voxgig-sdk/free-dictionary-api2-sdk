...
// FreeDictionaryApi2 SDK clienttrack feature
...
class FreeDictionaryApi2ClienttrackFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    public function PostConstruct(FreeDictionaryApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeDictionaryApi2-SDK';
