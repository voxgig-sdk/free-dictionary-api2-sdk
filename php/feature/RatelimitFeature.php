...
// FreeDictionaryApi2 SDK ratelimit feature
...
class FreeDictionaryApi2RatelimitFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _acquire(FreeDictionaryApi2Context $ctx): void
    {
    ...
    private function _track(FreeDictionaryApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
