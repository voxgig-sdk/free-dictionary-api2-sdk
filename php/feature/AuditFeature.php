...
// FreeDictionaryApi2 SDK audit feature
...
class FreeDictionaryApi2AuditFeature extends FreeDictionaryApi2BaseFeature
{
    ...
    private function _emit(FreeDictionaryApi2Context $ctx, string $outcome): void
    {
