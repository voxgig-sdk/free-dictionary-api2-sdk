...
// FreeDictionaryApi2 SDK utility type

class FreeDictionaryApi2Utility
{
    ...
    public static function copy(FreeDictionaryApi2Utility $src): FreeDictionaryApi2Utility
    {
        $u = new FreeDictionaryApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
