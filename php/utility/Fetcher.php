...
class FreeDictionaryApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeDictionaryApi2SDK/1.0)';
    ...
    public static function call(FreeDictionaryApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
