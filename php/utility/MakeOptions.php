...
// FreeDictionaryApi2 SDK utility: make_options

class FreeDictionaryApi2MakeOptions
{
    ...
    public static function call(FreeDictionaryApi2Context $ctx): array
    {
        ...
        //
        // `FreeDictionaryApi2Schema::optspec()` is built from the model:
        ...
        $optspec = FreeDictionaryApi2Schema::optspec();
