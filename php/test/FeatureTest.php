...
// FreeDictionaryApi2 SDK feature test
//
...
class FtCtrl extends FreeDictionaryApi2Control
{
...
class FtClient
{
    ...
    private FreeDictionaryApi2Utility $utility;

    public function __construct(FreeDictionaryApi2Utility $utility, array $options)
    {
    ...
    public function get_utility(): FreeDictionaryApi2Utility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (FreeDictionaryApi2Context $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public FreeDictionaryApi2Context $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (FreeDictionaryApi2Context $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = FreeDictionaryApi2Config::make_feature($name);
    ...
    private static function buildUrl(FreeDictionaryApi2Spec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof FreeDictionaryApi2Error) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new FreeDictionaryApi2Response($fetched);
        }
    ...
    private function fail(FreeDictionaryApi2Context $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (FreeDictionaryApi2Context $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
