...
class EntryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREEDICTIONARYAPI__TEST_ENTRY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function entry_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREEDICTIONARYAPI__TEST_ENTRY_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["FREEDICTIONARYAPI__TEST_ENTRY_ENTID"]);
