...
class PipelineTest extends TestCase
{
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeDictionaryApi2Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeDictionaryApi2Spec(['headers' => $headers]),
        ]);
    }
