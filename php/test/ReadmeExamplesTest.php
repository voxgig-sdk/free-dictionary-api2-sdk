...
// FreeDictionaryApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeDictionaryApi2SDK::test)
...
{
    private const SDK_CLASS = 'FreeDictionaryApi2SDK';
    ...
    private const SDK_BASE = 'freedictionaryapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freedictionaryapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
