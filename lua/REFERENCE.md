# FreeDictionaryApi2 Lua SDK Reference

Complete API reference for the FreeDictionaryApi2 Lua SDK.
...
```lua
local result, err = client:Entry():load({ language = "language", word = "word" })
```
