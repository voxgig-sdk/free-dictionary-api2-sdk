...
function runner.env_override(m)
  local live = runner.getenv("FREEDICTIONARYAPI2_TEST_LIVE")
  local override = runner.getenv("FREEDICTIONARYAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEDICTIONARYAPI2_TEST_EXPLAIN")
