...
function runner.env_override(m)
  local live = runner.getenv("FREE_DICTIONARY_API2_TEST_LIVE")
  local override = runner.getenv("FREE_DICTIONARY_API2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREE_DICTIONARY_API2_TEST_EXPLAIN")
