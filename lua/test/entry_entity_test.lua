...
describe("EntryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREEDICTIONARYAPI__TEST_ENTRY_ENTID JSON to run live")
      return
    end
...
function entry_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREEDICTIONARYAPI__TEST_ENTRY_ENTID")
