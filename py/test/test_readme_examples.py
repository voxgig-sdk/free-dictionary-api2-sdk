# FreeDictionaryApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeDictionaryApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeDictionaryApi2SDK(...) and FreeDictionaryApi2SDK.test(...) become
#      FreeDictionaryApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freedictionaryapi2_sdk"
_SDK_CLASS = "FreeDictionaryApi2SDK"
