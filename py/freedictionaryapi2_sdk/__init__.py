...
from freedictionaryapi2_sdk.utility import register

# Load features
from freedictionaryapi2_sdk.feature.base_feature import FreeDictionaryApi2BaseFeature
from freedictionaryapi2_sdk.features import _has_feature, _make_feature
...
class FreeDictionaryApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeDictionaryApi2Utility()
        self._utility = utility

        from freedictionaryapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeDictionaryApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeDictionaryApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entry(self, data=None) -> "EntryEntity":
        ...
        from freedictionaryapi2_sdk.entity.entry_entity import EntryEntity
    ...
    def Language(self, data=None) -> "LanguageEntity":
        ...
        from freedictionaryapi2_sdk.entity.language_entity import LanguageEntity
