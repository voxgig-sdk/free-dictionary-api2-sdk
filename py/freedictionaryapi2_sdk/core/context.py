...
from freedictionaryapi2_sdk.core.control import FreeDictionaryApi2Control
...
from freedictionaryapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeDictionaryApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FreeDictionaryApi2Control()
        ...
        if isinstance(sp, FreeDictionaryApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeDictionaryApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeDictionaryApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FreeDictionaryApi2Operation({})
        ...
        op = FreeDictionaryApi2Operation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return FreeDictionaryApi2Error(code, msg, self)
