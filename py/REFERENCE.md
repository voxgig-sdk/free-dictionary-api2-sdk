# FreeDictionaryApi2 Python SDK Reference

Complete API reference for the FreeDictionaryApi2 Python SDK.
...
#### `FreeDictionaryApi2SDK.test(testopts=None, sdkopts=None)`
