# FreeDictionaryApi2 Python SDK



The Python SDK for the FreeDictionaryApi2 API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/free-dictionary-api2-sdk/releases)) or
...
```
py/
├── freedictionaryapi2_sdk.py         -- Main SDK module
