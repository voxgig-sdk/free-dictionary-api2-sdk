# FreeDictionaryApi2 Golang SDK Reference

Complete API reference for the FreeDictionaryApi2 Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeDictionaryApi2SDK`
...
#### `Entry(data map[string]any) FreeDictionaryApi2Entity`

Create a new `Entry` entity instance. Pass `nil` for no initial data.

#### `Language(data map[string]any) FreeDictionaryApi2Entity`
