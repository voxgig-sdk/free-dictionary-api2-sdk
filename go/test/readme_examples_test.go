...
const testSeed = `map[string]any{"entity": map[string]any{"entry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "language": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
