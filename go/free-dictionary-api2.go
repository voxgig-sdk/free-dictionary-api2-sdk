...
// instead of `sdk.NewFreeDictionaryApi2SDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FreeDictionaryApi2SDK  { return NewFreeDictionaryApi2SDK(nil) }
func Test() *FreeDictionaryApi2SDK { return TestSDK(nil, nil) }
