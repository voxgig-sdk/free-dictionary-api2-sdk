...
class EntryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREEDICTIONARYAPI__TEST_ENTRY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def entry_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREEDICTIONARYAPI__TEST_ENTRY_ENTID"]
