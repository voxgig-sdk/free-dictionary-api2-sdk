...
#      offline in seeded test mode (FreeDictionaryApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeDictionaryApi2_sdk.rb")
  SDK_CLASS = "FreeDictionaryApi2SDK"
  ...
  SDK_BASE = "FreeDictionaryApi2_sdk"
