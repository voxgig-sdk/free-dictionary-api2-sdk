...
// FreeDictionaryApi2 SDK pipeline test
//
...
{
    private static function utility(): FreeDictionaryApi2Utility
    {
        return new FreeDictionaryApi2Utility();
    }
    ...
    private static function ctx(array $over = []): FreeDictionaryApi2Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeDictionaryApi2Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeDictionaryApi2Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeDictionaryApi2MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeDictionaryApi2MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeDictionaryApi2MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeDictionaryApi2Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeDictionaryApi2MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeDictionaryApi2Response([]),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        [, $err] = FreeDictionaryApi2MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec([]),
            'response' => null,
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        [, $err] = FreeDictionaryApi2MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec(['step' => 's']),
            'response' => new FreeDictionaryApi2Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        [, $err] = FreeDictionaryApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec(['step' => 's']),
            'response' => new FreeDictionaryApi2Response(self::resp(200, ['v' => 1])),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        [, $err] = FreeDictionaryApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec(['step' => 's']),
            'response' => new FreeDictionaryApi2Response(self::resp(200, ['v' => 2])),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryApi2MakeResponse::call($ctx);
    ...
    {
        $preset = new FreeDictionaryApi2Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec([]),
            'response' => new FreeDictionaryApi2Response([]),
            'result' => new FreeDictionaryApi2Result([]),
        ...
        [$got, $err] = FreeDictionaryApi2MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeDictionaryApi2Result([])]);
        [, $err] = FreeDictionaryApi2MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeDictionaryApi2Spec([]), 'result' => null]);
        [, $err] = FreeDictionaryApi2MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeDictionaryApi2Spec(['step' => 's']),
            'result' => new FreeDictionaryApi2Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeDictionaryApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeDictionaryApi2Spec(['step' => 's']),
            'result' => new FreeDictionaryApi2Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeDictionaryApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeDictionaryApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeDictionaryApi2Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeDictionaryApi2Spec([]),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeDictionaryApi2MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeDictionaryApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeDictionaryApi2Error('boom', 'boom');
        $utility->fetcher = function (FreeDictionaryApi2Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeDictionaryApi2Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeDictionaryApi2MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeDictionaryApi2Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeDictionaryApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeDictionaryApi2Response::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeDictionaryApi2Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeDictionaryApi2Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeDictionaryApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeDictionaryApi2Response(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeDictionaryApi2Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeDictionaryApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeDictionaryApi2MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeDictionaryApi2MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeDictionaryApi2Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeDictionaryApi2Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeDictionaryApi2Result(['ok' => false])]);
        $this->expectException(FreeDictionaryApi2Error::class);
        FreeDictionaryApi2Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeDictionaryApi2Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeDictionaryApi2MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryApi2MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeDictionaryApi2BaseFeature();
        $b = new FreeDictionaryApi2BaseFeature();
        FreeDictionaryApi2FeatureAdd::call($ctx, $a);
        FreeDictionaryApi2FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeDictionaryApi2BaseFeature
    {
        $f = new FreeDictionaryApi2BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeDictionaryApi2FeatureAdd::call($ctx, self::named_feature('a'));
        FreeDictionaryApi2FeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FreeDictionaryApi2FeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FreeDictionaryApi2FeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FreeDictionaryApi2FeatureAdd::call($ctx, $replace);
        ...
        FreeDictionaryApi2FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?FreeDictionaryApi2Spec $spec): FreeDictionaryApi2Context
    {
    ...
    private static function auth_bags(): FreeDictionaryApi2Spec
    {
        return new FreeDictionaryApi2Spec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        FreeDictionaryApi2PrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeDictionaryApi2PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeDictionaryApi2Response(['headers' => null]),
            'result' => new FreeDictionaryApi2Result([]),
        ]);
        FreeDictionaryApi2ResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FreeDictionaryApi2ResultBody::call($ctx);
