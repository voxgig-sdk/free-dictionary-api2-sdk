...
// FreeDictionaryApi2 SDK utility: graphql
//
...
class FreeDictionaryApi2Graphql
{
    ...
    // equivalent.
    public static function body(FreeDictionaryApi2Context $ctx): mixed
    {
    ...
    public static function errors(FreeDictionaryApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
