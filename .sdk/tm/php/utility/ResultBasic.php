...
// FreeDictionaryApi2 SDK utility: result_basic

class FreeDictionaryApi2ResultBasic
{
    public static function call(FreeDictionaryApi2Context $ctx): ?FreeDictionaryApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FreeDictionaryApi2Error) ? $result->err->msg : (string)$result->err;
