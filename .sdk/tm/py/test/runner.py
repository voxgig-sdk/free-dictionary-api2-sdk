...
class FreeDictionaryApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeDictionaryApi2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeDictionaryApi2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeDictionaryApi2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
