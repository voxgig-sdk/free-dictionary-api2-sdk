...
|---|---|---|
| `ts/` | @voxgig-sdk/free-dictionary-api2-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/free-dictionary-api2-sdk \
      --repository voxgig-sdk/free-dictionary-api2-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/free-dictionary-api2-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/free-dictionary-api2-sdk --id=<id>` removes one.
